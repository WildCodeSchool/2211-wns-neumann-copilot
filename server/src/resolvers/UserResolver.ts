...
export default class UserResolver {
  ...
  async updateProfile(
    ...
    { expoNotificationsToken }: UserUpdateNativeInput
  ): Promise<User> {
    return await datasource
      .getRepository(User)
      .save({ ...currentUser, expoNotificationsToken });
  }
  ...
  async sendNotification(
    ...
    if (
      user.expoNotificationsToken === null ||
      typeof user.expoNotificationsToken === "undefined"
    )
